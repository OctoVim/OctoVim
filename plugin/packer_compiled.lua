...
_G.packer_plugins = {
  ...
  ["DAPInstall.nvim"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/DAPInstall.nvim",
  ...
  catppuccin = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["cmp-emoji"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/cmp-emoji",
  ...
  ["cmp-under-comparator"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/cmp-under-comparator",
  ...
  ["live-server.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/peter/.local/share/nvim/site/pack/packer/opt/live-server.nvim",
  ...
  ["neoscroll.nvim"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/neoscroll.nvim",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  ["project.nvim"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/project.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/vim-bbye",
  ...
  ["winbar.nvim"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/winbar.nvim",
